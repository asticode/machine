...
[![GoDoc](https://godoc.org/github.com/asticode/machine?status.png)](https://godoc.org/github.com/asticode/machine)
...
Example of cloning and preparing the correct environment `GOPATH`:
    ...
    $ cd docker-machine
    $ export GOPATH="$PWD"
    $ go get github.com/asticode/machine
    $ cd src/github.com/asticode/machine
